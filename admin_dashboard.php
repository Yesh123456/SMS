...
<body>
	...
	<span id="top_span"><marquee>Note:- Plz confirm your details so you will recieve notifications about exams and other notices.</marquee></span>
	<div id="left_side">
		<br><br><br>
		<form action="" method="post">
			<table>
				<tr>
					<td>
						<input type="submit" class="main" name="search_student" value="Search Student">
					</td>
				</tr>
				<tr>
					<td>
						<input type="submit" class="main" name="edit_student" value="Edit Student">
					</td>
				</tr>
				<tr>
					<td>
						<input type="submit" class="main" name="add_new_student" value="Add New Student">
					</td>
				</tr>
				<tr>
					<td>
						<input type="submit" class="main" name="delete_student" value="Delete Student">
					</td>
				</tr>
				<tr>
					<td>
						<input type="submit" class="main" name="show teacher" value="Show Teachers">
					</td>
				</tr>
			</table>
		</form>
					...
					while ($row = mysqli_fetch_assoc($query_run)) 
					{
						...
						<table>
							...
							<tr>
								...
								<td>
									<textarea rows="3" cols="40" disabled><?php echo $row['quality']?></textarea>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<input type="file" name="uploadfile" value="" disabled> 
								</td>
							</tr>
						</table>
						<?php
				...
				while ($row = mysqli_fetch_assoc($query_run)) 
				{
					...
					<form action="admin_edit_student.php" method="post">
						...
						<tr>
							...
							<td>
								<textarea rows="3" cols="40" name="quality"><?php echo $row['quality']?></textarea>
							</td>
						</tr>
						<tr>
							<td>
				...
				if(isset($_POST['add_new_student'])){
					...
					<form action="add_student.php" method="post">
						...
						<tr>
							...
							<td>
								<textarea rows="3" cols="40" placeholder="Optional" name="quality"></textarea>
							</td>
						</tr>
						<tr>
							<td>
